...
`
                    ...
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'NIGHTBOT', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙 SIMPLE SELECT' }, type: 1 },{ buttonId: `!rules`, buttonText: { displayText: 'RULES' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '👥 OWNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: IkyAds, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`minta ke gua: https://wa.me/17155448800`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
